...
export class  $npmConfigName1726227511953 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`available_methods\` (\`method_id\` int NOT NULL, \`student_id\` int NOT NULL, \`date_end\` timestamp NOT NULL, PRIMARY KEY (\`method_id\`, \`student_id\`)) ENGINE=InnoDB`);
